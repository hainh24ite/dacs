...
public class sanphamcontroller {
    ...
    private void AddClick(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dacs1/Admin/Sanpham/addsanpham.fxml"));
            ...
            e.printStackTrace();
            showAlert("Không thể mở form thêm sản phẩm: " + e.getMessage());
        }
    }
    ...
    private void UpdateClick(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dacs1/Admin/Sanpham/updatesanpham.fxml"));
            Parent root = loader.load();
            UpdateSanphamController controller = loader.getController();
            ...
            e.printStackTrace();
            showAlert("Lỗi khi mở form sửa: " + e.getMessage());
        }
    }
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dacs1/Admin/Sanpham/xoasanpham.fxml"));
            Parent root = loader.load();

            DeleteSanphamController controller = loader.getController();
            controller.setData(selected);
            ...
            e.printStackTrace();
            showAlert("Không thể mở form xóa sản phẩm: " + e.getMessage());
        }
    }
    ...
    private void DetailClick(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dacs1/Admin/Sanpham/chitietsanpham.fxml"));
            Parent root = loader.load();

            ChitietSanphamController controller = loader.getController();
            controller.setData(selected);
