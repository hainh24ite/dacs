package com.example.dacs1.AdminController.HDXController;
...
public class HoadonController {
    ...
    private void xoaHoadonxuat(MouseEvent event) {
        ...
        if (hoadon == null){
            ...
            alert.setTitle("Không có hóa đơn nào được chọn");
            alert.setHeaderText("Vui lòng chọn hóa đơn cần xóa");
            alert.showAndWait();
            return;
        }
        ...
        confirmation.setHeaderText("Bạn có chắc chắn muốn xóa hóa đơn này?");
    ...
    private void chitietHoadonxuat(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dacs1/Admin/Hoadonxuat/chitiethoadonxuat.fxml"));
            Parent root = loader.load();
            ChitietHoadonxuat controller = loader.getController();
